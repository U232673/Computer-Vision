...
\centering
\begin{subfigure}[b]{0.45\linewidth}
\includegraphics[width=\linewidth]{figures/barcelona.png}
\caption{Before merging.}
\end{subfigure}
\caption{Effect of the merging auxiliary function on a test image.}
\label{fig:merge_test}
...
\centering
\begin{subfigure}[b]{0.45\linewidth}
\includegraphics[width=\linewidth]{figures/schindler.png}
\caption{Before merging.}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.45\linewidth}
\includegraphics[width=\linewidth]{figures/cameroon.png}
\caption{After merging.}
\end{subfigure}
\caption{Effect of the merging auxiliary function on a test image.}
\label{fig:merge_test}
